...
import CreateQurstionScreen from "../screens/CreateQurstionScreen";



const homeName = "Home";
const quizScreen = "Quiz";
const createQurstionScreen = "Create Question";
  ...
  return (
    <>
      ...
      <Tab.Navigator
        ...
        screenOptions={({ route }) => ({
          ...
          tabBarIcon: ({ focused, color }) => {
            ...
            } else if (rn == quizScreen) {
              iconName = focused ? "clipboard" : "clipboard-outline";
            } else if (rn == createQurstionScreen) {
      ...
      >
        ...
        <Tab.Screen name={createQurstionScreen} component={CreateQurstionScreen} />
      </Tab.Navigator>
    </>
  );
}
